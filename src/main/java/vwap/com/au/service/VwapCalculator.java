package vwap.com.au.service;

import org.springframework.stereotype.Service;
import vwap.com.au.dto.DataPoint;
import vwap.com.au.dto.VwapData;
...
public class VwapCalculator {
    ...
    public Function<DataPoint, Void> addPriceUpdate() {
        return event -> {
            String currencyPair = event.getCurrencyPair();
            ...
            VwapData data;
            Object lock;
            //String currencyPair, LocalDateTime timestamp, double price, double volume
            /*
             ...
             * */
            synchronized (lock) {
                data.getDeque().addLast(new DataPoint(currencyPair, timestamp, price, volume));
